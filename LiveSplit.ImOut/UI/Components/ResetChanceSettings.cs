...
namespace LiveSplit.UI.Components
{
    public partial class ResetChanceSettings : UserControl
    {
        ...
        {
            if (rdoDecimalZero.Checked) Accuracy = ResetChanceAccuracy.ZeroDecimal;
            else if (rdoDecimalOne.Checked) Accuracy = ResetChanceAccuracy.OneDecimal;
            else Accuracy = ResetChanceAccuracy.TwoDecimal;
        }
